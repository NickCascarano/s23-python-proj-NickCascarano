# Don't modify this file, it provides some fake data, so that the student in charge of stats module can
# test the code even if the dictionaries in parser are not completed by the other team member.
# This also helps the student responsible for working on the parser module to understand what
